...
public class Methods_Exr_11_ArrayManipulator {
                ...
                case "first":
                    ...
                    if (count > array.length){
                        ...
                        if (evenOrOdd.equals("even")) {
                            ...
                            findFirstCountOddNumbers(array);
                        }
                    }
                    break;
                case "last":
    ...
    private static void reverseArray(int[] array) {
        int[] temp = coppyArray(array);
        for (int i = array.length - 1; i >= 0 ; i--) {
              array[i] = temp[array.length - 1 - i];
        }
    }

    private static void findFirstCountOddNumbers(int[] array) {
